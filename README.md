...
veri artırımı uygulanmamış halinde ise test verisi %53 sonuç vermiştir.[buraya tıklayabilirsiniz](https://github.com/MuhammedDilli/bone-fracture-clasification/blob/main/ham_sonuc.ipynb)
